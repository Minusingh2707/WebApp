...
public class ftat {
	...
	public String URL = "http://54.165.110.142:30000/AVNCommunication-1.0";
	public String URL1 = "http://54.165.110.142:30000/AVNCommunication-1.0/avncreatepage.jsp";
	...
	public void pageredirection() {
		driver.findElement(By.partialLinkText("Home1")).click();
		driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
